...
import { ArrowDownIcon, ArrowUpIcon, MinusIcon, SearchIcon, XIcon } from 'lucide-react';
          ...
          <div className="relative">
            ...
            {busqueda && (
              <button
                ...
                className="absolute top-1/2 right-1 z-10 flex size-7 -translate-y-1/2 items-center justify-center rounded-full text-muted-foreground transition-colors hover:bg-foreground/8 hover:text-foreground focus-visible:ring-[3px] focus-visible:ring-ring/24 focus-visible:outline-none"
              >
