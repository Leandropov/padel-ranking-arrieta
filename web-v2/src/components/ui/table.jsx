...
export function TableHead(
  ...
  return (
    // ex-data-table-cell: headerTypography is caption (12/400/16lh) styled
    // as a "mono-caps eyebrow" - uppercase + letter-spacing.
    <th
      className={cn(
        "h-10 whitespace-nowrap px-2.5 text-left align-middle text-xs font-normal uppercase tracking-wider text-muted-foreground leading-none has-[[role=checkbox]]:w-px last:has-[[role=checkbox]]:ps-0 first:has-[[role=checkbox]]:pe-0",
        className
      )}
